...
export const Hero = (props: HeroProps) => {
  ...
  const changeBigShoeImage = (img_url: string) => {
    setBigShoeImg(img_url);
  };
  return (
    <>
      <section
      ...
      >
        <div className="relative xl:w-2/5 flex flex-col justify-cernter items-start w-full max-xl:padding-x pt-28">
